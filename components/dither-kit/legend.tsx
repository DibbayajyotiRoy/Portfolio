      ...
      {chart.names.map((name) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 font-mono text-[11px] text-oklch(0.552 0.016 285.938) transition-opacity dark:text-oklch(0.705 0.015 286.067)",
              isClickable &&
                "pointer-events-auto cursor-pointer hover:text-oklch(0.141 0.005 285.823) dark:hover:text-oklch(0.985 0 0)",
              dimmed && "opacity-40"
            )}
          >
            <span
