              ...
              <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm flex flex-wrap gap-x-4 gap-y-1">
                    <Link href="https://klinder-oss.vercel.app" target="_blank" rel="noopener noreferrer" className="font-semibold underline">Open the demo →</Link>
                    <Link href="/klinder-vs-posthog" className="underline">Compare vs PostHog →</Link>
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm flex flex-wrap gap-x-4 gap-y-1">
                    <Link href="https://www.npmjs.com/org/ahtmljs" target="_blank" rel="noopener noreferrer" className="font-semibold underline">npm scope →</Link>
                    <Link href="https://github.com/DibbayajyotiRoy/AHTML" target="_blank" rel="noopener noreferrer" className="underline">GitHub →</Link>
                    <Link href="/ahtml-vs-llms-txt" className="underline">Compare vs llms.txt →</Link>
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm flex flex-wrap gap-x-4 gap-y-1">
                    <Link href="https://www.npmjs.com/package/diffcore" target="_blank" rel="noopener noreferrer" className="font-semibold underline">npm install diffcore →</Link>
                    <Link href="https://rust-wasm-library.vercel.app" target="_blank" rel="noopener noreferrer" className="underline">Live demo →</Link>
                    <Link href="/diffcore-vs-jsondiffpatch" className="underline">Compare vs jsondiffpatch →</Link>
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm flex flex-wrap gap-x-4 gap-y-1">
                    <Link href="https://ai-for-bharat.vercel.app" target="_blank" rel="noopener noreferrer" className="font-semibold underline">Try it →</Link>
                  </p>
                </div>
              </div>
            </TitledParagraph>
