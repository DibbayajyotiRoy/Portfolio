...
const faq: FaqItem[] = [
  {
    ...
    a: "Diffcore — a JSON diff engine written in Rust, compiled to WebAssembly, and published on npm. It runs on Node, browsers, Bun, Deno, Cloudflare Workers, Vercel Edge, Electron, and Tauri.",
  },
  {
