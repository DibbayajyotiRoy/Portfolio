...
const Skills = () => {
  return (
    <div className="flex flex-col mt-[100px] justify-start items-center">
      <h3 className="text-xl mb-[-50px] md:mb-[-100px] text-bold text-neutral-200">
        Skills
      </h3>
...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-1 dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
