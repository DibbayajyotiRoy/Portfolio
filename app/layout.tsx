...
const personJsonLd = {
  ...
  "description": "Full Stack Software Engineer specializing in Rust, React, and Next.js. Creator of Klinder-OSS (unified analytics + session replay + email SDK), diffcore (Rust/WASM npm), AHTML (the sixteen-package @ahtmljs agentic-web scope plus Python SDK), whatbroke (git-anchored crash capture over MCP), Roy UI (zero-config React component library), and Fresco (a Rust + GTK4 live-wallpaper app for Linux). Builds production-grade SaaS platforms at Yupcha Softwares.",
  "mainEntityOfPage": {
    "@type": "WebPage",
