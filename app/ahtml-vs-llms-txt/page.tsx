...
const faq = [
  ...
  },
  {
    ...
    a: "Document.chunks ships deterministic IDs and byte ranges, so embeddings stay stable across deploys. Markdown gives you text but not stable chunk identity, anchors, or a typed action schema.",
  },
];
...
await client.dispatch("contact", { dryRun: true });`}
        ...
        <Reveal>
          <ChapterClose line="Making your site agent-ready? Let's talk about the options." />
        </Reveal>
      </section>
    </main>
  );
